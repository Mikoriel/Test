...
public class Heavy_One : MonoBehaviour
{
    //一発、中火力、広範囲
    public static float shootTimer;
    public static float shootTimerDeley = 2.0f; //射撃タイマー、射撃間隔

    private Rigidbody2D rb;
    [SerializeField]
    private float moveSpeed = 2.5f, deactiveTimer = 5f; //速度、消えるまでの時間
    [SerializeField]
    private int damageAmount = 2;   //攻撃力
